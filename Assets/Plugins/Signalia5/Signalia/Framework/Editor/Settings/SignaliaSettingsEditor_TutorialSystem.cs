...
namespace AHAKuo.Signalia.Framework.Editors
{
    ...
    {
        #region Game Systems - Tutorial System

        private void DrawTutorialTab()
        {
            GUILayout.Space(10);
            // TODO: Add Tutorial header graphic when available
            EditorUtilityMethods.RenderSignaliaHeader(GraphicLoader.TutorialHeader, maxWidthProperties);
            GUILayout.Space(10);
